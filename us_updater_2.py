...
def update_us_stocks_part_2():
    ...
    # SLICING LOGIC: Take only the SECOND HALF of the tickers
    ...
    # Save to a specific file for Part 2
    with open('us_data_2.json', 'w') as f:
        json.dump(stock_data, f, indent=4, cls=NumpyEncoder)
        
    print(f"Data saved: {len(stock_data)} US stocks saved to us_data_2.json.")
